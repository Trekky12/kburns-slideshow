...
class VideoSlide(Slide):
    ...
    def __init__(self, file, position, ffprobe, output_width, output_height, fade_duration = 1):
        ...
        super().__init__(file, position, output_width, output_height, float(duration), fade_duration)
        self.video = True
