...
class ConfigFrame(tk.Toplevel):
    ...
    def create(self, config_path, choices):
        ...
        ffmpegEntry.grid(row=0, column=1, sticky=tk.EW, padx=4, pady=4)
        ...
        ffprobeEntry.grid(row=1, column=1, sticky=tk.EW, padx=4, pady=4)
        ...
        aubioEntry.grid(row=2, column=1, sticky=tk.EW, padx=4, pady=4)
        ...
        tempParametersLabel.grid(row=4, column=0, sticky=tk.EW, padx=4, pady=4)
