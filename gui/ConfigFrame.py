...
class ConfigFrame(tk.Toplevel):
    ...
    def create(self, config_path, choices):
        ...
        self.inputZoomDirection.set(self.config["zoom_direction"])
        ...
        transitionCombo = ttk.Combobox(transitionFrame, values=["random"] + choices["transition"], width=30, textvariable=self.inputTransition)
        ...
        buttonSaveSlide.grid(row=5, column=0, sticky=tk.NW, padx=4, pady=4)
